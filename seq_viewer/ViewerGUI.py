...
https://stackoverflow.com/questions/3085696/adding-a-scrollbar-to-a-group-of-widgets-in-tkinter/3092341#3092341
    ...
    def __init__(self, frame, fig, width=16, parent=None):
        ...
        self.windows_item = \
            self.tk_cnv.create_window(0, 0, window=self.cnv_widget, anchor='nw',
                                      tag='self.canvas')
...
class StartPage(Frame):
    ...
    def __init__(self, parent, controller):
        ...
        params = SubplotParams(left=0.05, right=0.95, top=0.98, bottom=0.02)
        self.plot_fig = Figure(figsize=[10.0, 10.0], subplotpars=params,
                               constrained_layout=False)

        # self.plot_fig.subplots_adjust(hspace=1.75)
        # Setup for changing the size of the axes in the plot
        widths = [1]
        heights = self.get_repeat_list([0.75], 8)
